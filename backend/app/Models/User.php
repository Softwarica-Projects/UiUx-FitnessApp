...
class User extends Authenticatable implements MustVerifyEmail, HasMedia
{
     ...
     * @var array
     */
    protected $fillable = [ 'username', 'first_name', 'last_name', 'phone_number', 'status', 'email', 'password', 'gender', 'display_name', 'login_type', 'user_type', 'player_id', 'timezone','last_notification_seen' ];
