...
class _ExerciseDetailScreenState extends State<ExerciseDetailScreen> {
  ...
  Widget dividerHorizontalLine({bool? isSmall = false}) {
    return Container(height: isSmall == true ? 40 : 65, width: 4, color: context.scaffoldBackgroundColor);
  }
    ...
    return value2.isEmptyOrNull || value2 == '0.00'
        ...
        : Column(
            ...
            children: [
              ...
              2.height,
              Text("- ${value2?.validate() ?? '0'} ${isLBSClicked ? languages.lblLbs : languages.lblKg}", style: primaryTextStyle(size: 14)),
            ],
          );
  }
  ...
  Widget mSets1() {
    if (mExerciseModel?.data?.sets?.length == 1) {
      return mSetText(
        mExerciseModel?.data?.based == "reps" ? mExerciseModel?.data?.sets?.first.reps ?? '' + "x" : mExerciseModel?.data?.sets?.first.time ?? '' + "s",
      ...
      return Row(
        children: [
          ...
          mSetText(
            mExerciseModel?.data?.based == "reps" ? mExerciseModel!.data!.sets![1].reps.validate() + "x" : mExerciseModel?.data?.sets![1].time ?? '' + "s",
      ...
      return Row(
        children: [
          mSetText(
            mExerciseModel?.data?.based == "reps" ? mExerciseModel?.data?.sets![0].reps ?? '' + "x" : mExerciseModel?.data?.sets![0].time ?? '' + "s",
            value2: mExerciseModel?.data?.sets![0].weight.validate(),
          ).expand(),
          dividerHorizontalLine(),
          mSetText(
            mExerciseModel?.data?.based == "reps" ? mExerciseModel?.data?.sets![1].reps ?? "" + "x" : mExerciseModel?.data?.sets![1].time ?? '' + "s",
            value2: mExerciseModel?.data?.sets![1].weight.validate(),
          ).expand(),
          dividerHorizontalLine(),
          mSetText(
            mExerciseModel?.data?.based == "reps" ? mExerciseModel?.data?.sets![2].reps ?? '' + "x" : mExerciseModel?.data?.sets![2].time ?? '' + "s",
        ...
        itemBuilder: (context, index) {
          return Row(
            children: [
              16.width,
              mSetText(
                mExerciseModel!.data!.based == "reps" ? mExerciseModel!.data!.sets![index].reps.validate() + "x" : mExerciseModel!.data!.sets![index].time.toString() + "s",
  ...
  Widget mSets2() {
    if (mExerciseModel?.data?.sets != null && mExerciseModel?.data?.sets?.length == 1) {
      ...
      return Row(
        children: [mSetText(mExerciseModel?.data?.sets?[0].rest ?? '' + "s").expand(), dividerHorizontalLine(isSmall: true), mSetText(mExerciseModel?.data?.sets?[1].rest ?? '' + "s").expand()],
      );
      ...
      return HorizontalList(
        ...
        itemBuilder: (context, index) {
          return Row(children: [16.width, mSetText(mExerciseModel?.data?.sets?[index].rest ?? '' + "s"), 16.width, dividerHorizontalLine(isSmall: true), 16.width]);
        },
      );
    } else {
      return SizedBox(child: Text(languages.lblNoSetsMsg).center());
          ...
          if (snapshot.hasData) {
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  if (mExerciseModel!.data!.videoUrl.validate().isNotEmpty)
                    Stack(
                      children: [
