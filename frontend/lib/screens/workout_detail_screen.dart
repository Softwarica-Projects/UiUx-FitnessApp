                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Image.asset(mWorkoutDetailModel!.isFavourite == 1 ? ic_favorite_fill : ic_favorite,
                                          color: mWorkoutDetailModel!.isFavourite == 1 ? favColor : white, width: 20, height: 20)
                                      .center(),
                                ),
                              ),
                            ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (!appStore.isLoading)
                                Column(
                                  children: [
                                    HtmlWidget(postContent: mWorkoutDetailModel?.description.validate())
                                        .paddingSymmetric(horizontal: 8)
                                        .visible(!(mWorkoutDetailModel?.description.isEmptyOrNull ?? false)),
                                    20.height,
                                    TabBar(
                                    ...
                                    Stack(
                                      children: [
                                        mDayExerciseList.isNotEmpty
                                            ...
                                            : Text(
                                                    mWorkoutDayList.isEmpty || currentTabIndex < 0 || currentTabIndex >= mWorkoutDayList.length
                                                        ? languages.lblNoFoundData
                                                        : mWorkoutDayList[currentTabIndex].isRest == 1
                                                            ? languages.lblBreak
                                                            : languages.lblNoFoundData,
