...
class _DietDetailScreenState extends State<DietDetailScreen> {
                      ...
                      child: Column(
                        ...
                        children: [
                          IconButton(
                            ...
                            icon: Icon(Octicons.chevron_left, color: whiteColor),
                          ),
                        ],
                      )),
                  Positioned(
                      ...
                      child: Container(
                          ...
                          child: Image.asset(
                            ...
                            height: 20,
                            width: 20,
                            color: widget.dietModel!.isFavourite == 1 ? favColor : Colors.white,
                          )).onTap(() {
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: boxDecorationWithRoundedCorners(backgroundColor: whiteColor.withOpacity(0.3), borderRadius: radius(8)),
                          child: RichText(
                            text: TextSpan(
                              children: [
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      8.height,
                      Divider(color: context.dividerColor, indent: 16, endIndent: 16, height: 0.5),
                      8.height,
                      Container(
                        padding: EdgeInsets.only(top: 22),
                        decoration: BoxDecoration(border: Border(bottom: BorderSide(color: context.dividerColor, width: 0.5))),
                        child: Row(children: [
                          Container(
  ...
  Widget ingredients() {
    if ((widget.dietModel!.ingredients ?? "").toString().isEmpty) {
      return Text("No Ingredients Available", style: secondaryTextStyle()).paddingSymmetric(horizontal: 8);
    }
    return HtmlWidget(postContent: widget.dietModel!.ingredients.toString()).paddingSymmetric(horizontal: 8);
  }

  Widget instruction() {
    if ((widget.dietModel!.description ?? "").toString().isEmpty) {
      return Text("No Instructions Available", style: secondaryTextStyle()).paddingSymmetric(horizontal: 8);
    }
