        ...
        children: [
          SingleChildScrollView(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(
                children: [
                  Icon(Octicons.chevron_left, color: primaryColor, size: 28).onTap(() {
                  ...
                  AppTextField(
                    ...
                    onChanged: (v) {
                      ...
                      mIsSearch = true;
                      mExerciseList.clear();
                      getExerciseData(isFilter: true, ids: SelectedId, isEquipment: selectedFilterList == 1 ? true : false, isLevel: selectedFilterList == 2 ? true : false);
                      setState(() {});
                    },
                  ).expand()
                ],
