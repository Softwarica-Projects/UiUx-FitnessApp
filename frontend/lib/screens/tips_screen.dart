    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            if (widget.mExerciseVideo.validate().isNotEmpty) 16.height,
            widget.mExerciseVideo!.validate().contains("https://youtu") || widget.mExerciseVideo!.validate().contains("https://www.youtu")
                ? AspectRatio(
                    aspectRatio: mode == "portrait" ? 12 / 7 : 15 / 7,
                    child: YoutubePlayerScreen(url: widget.mExerciseVideo.validate(), img: widget.mExerciseImage.validate(), hideControl: true),
                  )
