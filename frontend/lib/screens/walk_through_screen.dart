...
class _WalkThroughScreenState extends State<WalkThroughScreen> {
  ...
  init() async {
    //
    mWalkList.add(WalkThroughModel(image: walkthrough1, title: WALK1_TITLE));
    mWalkList.add(WalkThroughModel(image: walkthrough2, title: WALK2_TITLE));
    mWalkList.add(WalkThroughModel(image: walkthrough3, title: WALK3_TITLE));
  }
          ...
          children: [
            PageView(
              ...
              children: mWalkList.map((e) {
                return Column(
                  children: [
                    Image.asset(mWalkList[mCurrentIndex].image!, height: context.height() * 0.65, fit: BoxFit.contain),
                  ],
