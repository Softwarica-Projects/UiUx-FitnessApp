...
import 'package:habit_tracker/extensions/common.dart';
    ...
    return Padding(
      ...
      child: ClipRRect(
        ...
        child: MaterialButton(
          ...
          child: widget.child ?? Text(widget.text!.validate(), style: widget.textStyle ?? boldTextStyle(color: widget.textColor ?? Colors.white)),
