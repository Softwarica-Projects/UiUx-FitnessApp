...
InputDecoration defaultInputDecoration(BuildContext context, {String? hint, String? label, TextStyle? textStyle, bool? isFocusTExtField = false, Widget? mPrefix, Widget? mSuffix}) {
...
Decoration boxDecorationWithRoundedCorners({
  ...
  return BoxDecoration(
    color: backgroundColor == null ? cardLightColor : backgroundColor,
