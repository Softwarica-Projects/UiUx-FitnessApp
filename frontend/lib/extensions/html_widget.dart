...
import 'package:habit_tracker/components/VimeoEmbedWidget.dart';
import 'package:habit_tracker/components/YouTubeEmbededWidget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Html(
      ...
      style: {
        ...
        "tr": Style(
          border: Border(bottom: BorderSide(color: Colors.black45.withOpacity(0.5))),
        ),
...
Widget iconsBackgroundWidget(BuildContext context, {String? name, String? image, Color? color}) {
  return Container(
    color: primaryColor,
    ...
    child: Column(
      children: [
        Stack(
          ...
          children: [
            Image.asset(image.validate(), height: 28, width: 28, color: Colors.white),
          ],
        ),
        8.height,
