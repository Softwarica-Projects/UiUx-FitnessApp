                    ...
                    Positioned(
                      ...
                      child: Container(
                          ...
                          child: Image.asset(
                            ...
                            height: 20,
                            width: 20,
                            color: widget.mDietModel!.isFavourite == 1 ? favColor : white,
                          )).onTap(
                        () {
                          setState(() {});
                  ...
                  children: [
                    ...
                    Positioned(
                        ...
                        child: Container(
                          ...
                          decoration: boxDecorationWithRoundedCorners(boxShape: BoxShape.circle, backgroundColor: Colors.white.withOpacity(0.5)),
                          child:
                              Image.asset(widget.mDietModel!.isFavourite == 1 ? ic_favorite_fill : ic_favorite, height: 20, width: 20, color: widget.mDietModel!.isFavourite == 1 ? favColor : white),
                        ).onTap(() {
                          setState(() {});
                          setDiet(widget.mDietModel!.id.validate());
                        })),
