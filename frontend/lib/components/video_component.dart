      ...
      children: [
        ...
        Positioned(
          ...
          child: Column(
            ...
            children: [
              Text("title.capitalizeFirstLetter().validate()", style: boldTextStyle(color: white), maxLines: 2, overflow: TextOverflow.ellipsis),
              4.height,
              Text("widget.mWorkoutModel!.levelTitle.validate()", style: secondaryTextStyle(color: white), maxLines: 1, overflow: TextOverflow.ellipsis),
            ],
          ),
        )
      ],
