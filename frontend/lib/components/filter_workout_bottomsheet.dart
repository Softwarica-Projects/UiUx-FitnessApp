                    ...
                    AnimatedListView(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Row(
                          ...
                          var selectedItems = widget.mWorkoutTypesList?.where((item) => item.select == true).toList();
                          if (widget.mWorkoutTypesList?.length == selectedItems?.length) {
                            isSelectedAll = true;
                          } else {
                            isSelectedAll = false;
                          }
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        isSecondSelectedAll
                            ? Text(languages.lblClearAll, style: primaryTextStyle(color: primaryColor)).onTap(() {
                                for (int i = 0; i < widget.mLevelList!.length; i++) {
                            ...
                            : Text(languages.lblSelectAll, style: primaryTextStyle(color: primaryColor)).onTap(() {
                                for (int i = 0; i < widget.mLevelList!.length; i++) {
                                  ...
                                  mLevelIdList.add(widget.mLevelList![i].id.validate());
                    ...
                    AnimatedListView(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Row(
                          ...
                          var selectedItems = widget.mLevelList?.where((item) => item.select == true).toList();

                          if (selectedItems?.length == widget.mLevelList?.length) {
                            isSecondSelectedAll = true;
                          } else {
                            isSecondSelectedAll = false;
                          }
