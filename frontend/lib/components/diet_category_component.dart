...
class _DietCategoryComponentState extends State<DietCategoryComponent> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: boxDecorationWithRoundedCorners(borderRadius: radius(12), backgroundColor: cardBackground),
      ...
      child: Column(
        children: [
          ...
          4.height,
          Text(widget.mCategoryDietModel!.title!.validate(), style: primaryTextStyle(size: 14), maxLines: 1, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center)
