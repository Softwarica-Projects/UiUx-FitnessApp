...
class ExerciseDayComponentState extends State<ExerciseDayComponent> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      ExerciseDetailScreen(mExerciseName: widget.mDayExerciseModel!.exerciseTitle.validate(), mExerciseId: widget.mDayExerciseModel!.exerciseId.validate(), workOutId: widget.workOutId)
          .launch(context);
    });
  }
}
