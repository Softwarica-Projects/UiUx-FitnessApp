    ...
    return SizedBox(
      ...
      child: Column(
        children: [
          ...
          6.height,
          Text(widget.bodyPartModel!.title.validate(), style: primaryTextStyle(size: 14, color: isBody == true ? primaryColor : Colors.black), textAlign: TextAlign.center, maxLines: 2),
        ],
      ),
    ).onTap(() {
      setState(() {
