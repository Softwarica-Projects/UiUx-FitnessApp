...
class DayExerciseModel {
  ...
  DayExerciseModel({this.id, this.workoutId, this.workoutDayId, this.exerciseId, this.exerciseImage, this.exerciseTitle, this.exercise, this.sequence, this.createdAt, this.updatedAt});
  ...
  DayExerciseModel.fromJson(Map<String, dynamic> json) {
    ...
    exercise = json['exercise'] != null ? new Exercise.fromJson(json['exercise']) : null;
...
class Exercise {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.bodypartName != null) {
      data['bodypart_name'] = this.bodypartName!.map((v) => v.toJson()).toList();
    }
